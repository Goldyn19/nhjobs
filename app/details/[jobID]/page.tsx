...
const Page = () => {
  ...
  return (
    <div>
      <TopNav />
      <div className="flex mx-auto md:border-2 md:shadow-md p-8 max-w-screen-lg md:mt-6 rounded-3xl mb-4">
        <div className="w-full">
          <div className="flex justify-between w-full container md:mb-10 mb-4">
            <div>
              ...
              <h1
                className={` md:font-bold font-semibold md:text-[40px] text-[25px] mt-0 leading-tight" ${poppins.className}`}
              >
                AEM Web Content
              </h1>
              <h4
                className={`md:text-[14px] text-[16px] md:font-normal font-medium ${poppins.className}`}
              >
                Remote
              </h4>
            </div>
            <div className="flex justify-center align-middle space-x-3">
              <div className="flex md:hidden">
                <Popover>
                  ...
                  <PopoverContent className="bg-white shadow-lg rounded-lg w-48 flex flex-col p-4 mx-2">
          ...
          <div className="md:space-y-2 space-y-4">
            <div className="p-6 bg-gray-100 rounded-[20px] space-y-4 mb-8">
              <h2 className={`font-bold text-[24px] ${poppins.className}`}>
                Job Details
              </h2>
            ...
            <div className="md:flex md:space-x-12 mt-8">
            ...
            <div className="md:flex md:space-x-8">
              ...
              <h4 className="text-[14px]">
                <ul className="list-disc pl-5">
                  ...
                  <li>
                    Ability to effectively communicate amongst multiple
                    workstreams and stakeholders
                  </li>
                  <li>
                    Knowledge of web development methodologies and tools (ex:
                    HTML, CSS, JavaScript, etc)
                  </li>
                  <li>
                    Minimum 1 year experience with project coordination, time
