    ...
    <nav className="bg-white border-b py-5 md:py-5 px-4 md:px-10 shadow-sm">
      ...
      <div className="container mx-auto h-full flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div className="hidden lg:flex space-x-2 ml-14 font-poppins text-sm">
            ...
            <Link
              href="/FAQ"
              className={`${
                currentPath === "/FAQ" ? "text-black bg-gray-300" : ""
              } hover:text-blue-500 transition-colors duration-200 px-4 py-1 rounded-xl font-semibold`}
            >
              FAQ
            </Link>
          </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link
            href="/"
            className="hidden lg:flex items-center text-gray-700 hover:text-blue-500 transition-colors duration-200"
          >
          ...
          <Popover>
            ...
            <PopoverContent className="bg-white shadow-lg rounded-lg w-48 flex flex-col p-4">
              <Link
                href="/profile"
                className="text-center text-gray-700 hover:text-blue-500 py-2 transition-colors duration-200"
              >
                My Profile
              </Link>
              <hr className="my-2" />
